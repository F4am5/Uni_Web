...
<html>
    ...
    <div id="container">
            ...
            <?php
                ...
                $search = $_POST['search'];
                $search2 = $_POST['search']; //Aight hear me out, let me cook
                ...
                else
                {
                    ...
                    $queryView = "SELECT * FROM SONG WHERE songTitle LIKE '%$search%'";

                    //To execute $queryView query & assign query result to $resultQ
                    $resultQ = $conn->query($queryView);

                    $queryView = "SELECT * FROM SONG WHERE artistBandName LIKE '%$search2%'";

                    $resultQ2 = $conn->query($queryView);
                }
