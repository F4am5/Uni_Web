    ...
    <body>
        ...
        <?php
            ...
            else
            {
                ...
                $queryView = "SELECT songID, songTitle, artistBandName, audioVideoLink, genre, language, releaseDate, status, uploader FROM SONG WHERE uploader = '".$_SESSION["userName"]."'";
        ...
        <form action="viewSongEditDetail.php" method="POST">
