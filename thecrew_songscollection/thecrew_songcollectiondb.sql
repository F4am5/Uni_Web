...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2024 at 05:36 AM
...
(7, '強風オールバック (Kyoufuu All Back) (Hair Swept Back By Gale-Force Winds)', 'Yukopi', 'https://youtu.be/D6DVTLvOupE?feature=shared', 'other', 'japanese', '2023-03-15', 'waiting', 'user2'),
...
(19, 'Yi Jian Mei (xue hua piao piao bei feng xiao xiao', 'Yu-Ching Fei', 'https://open.spotify.com/track/4wCSIuFOUBhcDIBtFBh4zF', 'folk', 'chinese', '2014-08-25', 'waiting', 'user2');
...
--
ALTER TABLE `song`
  MODIFY `songID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
